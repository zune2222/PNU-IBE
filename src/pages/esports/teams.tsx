...
export default function ESportsTeams() {
  ...
  return (
    <>
      <Head>
        <title>참가팀 목록 | E-Sports | 부산대학교 정보의생명공학대학 학생회</title>
      </Head>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {(['LOL', 'PUBG', 'FIFA'] as GameType[]).map((game) => (
                ...
                >
                  <div className="font-semibold text-gray-800">{getGameName(game)}</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {teams.map((team) => (
                ...
                >
                  ...
                  <div className="p-6">
                    {/* 팀명 */}
                    <h3 className="text-xl font-bold text-gray-900 mb-2 korean-text">
                      {team.teamName}
                    </h3>

                    {/* 한줄 소개 */}
                    {team.description && (
                      <p className="text-gray-600 text-sm mb-4 korean-text">
                        {team.description}
                      </p>
                    )}
                    ...
                    {/* 리더 정보 */}
                    <div className="mb-4">
                      <div className="text-sm font-medium text-gray-700 mb-2">리더</div>
                    ...
                    {selectedGame === 'PUBG' && team.members.length > 1 && (
                      <div className="mb-4">
                        <div className="text-sm font-medium text-gray-700 mb-2">팀원</div>
                    ...
                    {false && team.members[0]?.gameApiData && (
                      <div className="mt-4 pt-4 border-t border-gray-200">
                        <div className="text-sm font-medium text-gray-700 mb-2">전력 정보</div>
