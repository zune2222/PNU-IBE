              ...
              <ol className="list-decimal ml-6 space-y-2 text-gray-600">
                ...
                <li>
                  ...
                  <ul className="list-disc ml-6 mt-1">
                    ...
                    <li>
                      사용이 불가능한 정도의 손상은 대여자에게 100% 책임이
                      있으며, 동일한 물품을 구매하여 제출할 것을 요구합니다.
                    </li>
                  </ul>
                </li>
                <li>
                  ...
                  <ul className="list-disc ml-6 mt-1">
                    <li>
                      분실로 인해 반납이 불가능할 경우 대여자에게 100% 책임이
                      있으며, 동일한 물품을 구매하여 제출할 것을 요구합니다.
                    </li>
                  </ul>
                </li>
                ...
                <li>
                  물품 구매 제출을 요구받았으나 이를 이행하지 않을 경우, 해당
                  물품을 훔친 것으로 간주하여 영구 대여 제한 및 이후 학생회 행사
                  참여가 제한될 수 있습니다.
                </li>
              </ol>
            </section>
            ...
            <section className="space-y-4">
              ...
              <ol className="list-decimal ml-6 space-y-2 text-gray-600">
                ...
                <li>
                  ...
                  <ul className="list-disc ml-6 mt-1">
                    <li>
                      30분 이내 지연: 경고 1회 부여 (경고 3회 누적 시 1주일 대여
                      제한)
                    </li>
