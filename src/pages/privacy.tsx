          ...
          <div className="bg-white rounded-lg shadow-sm p-8 space-y-8">
            <section className="space-y-4">
              ...
              <p className="text-gray-600">
                ...
                학우들의 물품 대여 서비스, 행사 신청 및 진행, 학생회 활동 안내
                등을 위해 필요한 최소한의 개인정보를 처리하고 있습니다.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="text-gray-600">
                학생회는 물품 대여 서비스의 경우, 대여 신청일로부터 물품 반납
                완료 후 1개월까지 개인정보를 보유합니다. 이 기간이 지난 후에는
                해당 정보를 지체 없이 파기합니다.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-600">
                  대여 기간 중에는 대여 상태 확인, 반납 기한 안내, 연장 신청
                  처리 등을 위해 개인정보가 활용될 수 있습니다.
                </p>
                ...
                <p className="text-gray-600">
                  물품 반납 완료 후에는 물품의 상태 확인 및 추가적인 안내가
                  필요한 경우를 제외하고 수집된 개인정보는 1개월 후 자동으로
                  파기됩니다.
                </p>
              </div>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="text-gray-600">
                학생회는 수집된 개인정보를 본래의 목적 이외의 용도로 사용하거나
                외부에 제공하지 않습니다. 다만, 아래의 경우에는 예외적으로
                제공될 수 있습니다:
              </p>
              <ul className="list-disc ml-6 text-gray-600">
            ...
            <section className="space-y-4">
              ...
              <p className="text-gray-600">
                학생회는 수집된 개인정보를 안전하게 보호하기 위해 다음과 같은
                조치를 취하고 있습니다:
              </p>
              <ul className="list-disc ml-6 text-gray-600">
            ...
            <section className="space-y-4">
              ...
              <p className="text-gray-600 mt-2">
                위 권리 행사는 학생회에 서면, 전화, 이메일, 인스타그램 DM 등을
                통해 요청하실 수 있습니다.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="text-gray-600">
                이 개인정보처리방침은 2023년 1월 1일부터 적용됩니다. 법령 및
