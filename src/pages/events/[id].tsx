                            ...
                            <div>
                              ...
                              <p className="text-gray-600">
                                {event.registrationDeadline
                                  ? `신청 마감일: ${event.registrationDeadline.replace(
                                      /-/g,
                                      "."
                                    )}`
                                  : "자세한 사항은 주최측에 문의해주세요."}
                      ...
                      {event.registrationRequired && (
                        <li className="flex">
                          ...
                          <div>
                            ...
                            <p className="text-gray-800">필요</p>
                          </div>
                        </li>
                      )}
                      {event.registrationDeadline && (
                        <li className="flex">
                          ...
                          <div>
                            ...
                            <p className="text-gray-800">
                              {event.registrationDeadline.replace(/-/g, ".")}
                            </p>
                          </div>
                        </li>
                      )}
...
export const getStaticProps: GetStaticProps = async (context) => {
  ...
  // 이벤트 데이터 찾기
  const event = eventsData.find((item) => item.id === Number(id)) || null;
